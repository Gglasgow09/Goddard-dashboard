...
A condensed 10-section survey was designed in Jotform to capture the structure of Goddard Riverside's FY2025 Year-End Program Survey. The full survey was not replicated in its entirety due to Jotform's free-tier 100-row limit. Instead, a focused form was built that captures the three categories leadership needs most: program identification, staffing capacity, and participant demographics. 
...
The original survey used 11 age bands (0-5, 6-10, 11-15, etc.). The condensed form collapsed these into 5 broader brackets (Under 20, 21-40, 41-60, 61-84, 85+) to stay within the Jotform row limit while preserving the most analytically useful age groupings for a population that skews older. I intentionally left out the under 20 age group since it was zero for all 3 submissions.
...
Part-time staff were weighted at 0.5 FTE rather than 1.0 to reflect standard staffing conventions. This produced materially different workload figures — particularly for ACT Team, which has 4 part-time staff — and gives leadership a more accurate picture of actual capacity.
...
### Front-End Design
The HTML/CSS page follows a clear information hierarchy: summary statistics first, context second, interactive dashboard third, program details fourth, data quality last. This mirrors how leadership would naturally want to consume the information — starting with the big picture and drilling down.
...
| Jotform row limit | The free tier limits forms to 100 rows. The condensed survey was designed with this constraint in mind. |
...
| Google Sheet | https://docs.google.com/spreadsheets/d/1-542xg06BQ4D1I6GTcbXj1w0bhw6MhNx7yNZarC7NWY/edit?usp=sharing |
| Looker Dashboard | https://datastudio.google.com/reporting/6d3ce0a5-e16d-44c0-85af-92a52f255ec1 |
| HTML/CSS File | https://gglasgow09.github.io/Goddard-dashboard/ |
